...
import {
  ...
  ZoomIn, Download, Wand2, Volume2, VolumeX, Loader2, User
} from 'lucide-react'
...
export function MessageBubble({
  ...
  return (
    ...
    >
      ...
      <div className={cn('max-w-[82%] min-w-0 flex flex-col gap-2', isUser ? 'items-end' : 'items-start')}>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <img
                ...
                alt="Generated"
                className="max-w-full w-auto max-h-80 object-contain transition-transform duration-300 group-hover:scale-[1.01]"
              />
                      ...
                      if (isBlock) {
                        return (
                          <div className="relative my-3">
                            <pre className="bg-[hsl(220,15%,10%)] text-[hsl(210,12%,88%)] rounded-xl p-4 overflow-x-auto text-xs font-mono">
